...
cc._RF.push(module, '7f2ecQUHORGEqW+dmgHqyLc', 'rope', __filename);
// scripts/rope.js
...
cc.Class({
    ...
    _set_rope_empty: function _set_rope_empty() {
    ...
    _set_rope_with_cow: function _set_rope_with_cow(cow_type) {
